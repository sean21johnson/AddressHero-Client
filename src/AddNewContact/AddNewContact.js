                    ...
                    <div className="NewContact_Container">
                        ...
                        <div className="NewContact_Container_Buttons">
                            <div className="NewContact_Cancel">
                                <button className="NewContact_Button" type="button" onClick={addCancelClicked}>Cancel</button>
                            </div>
                            <div>
                                <button className="NewContact_Button" type="submit">Create Profile</button>
                            </div>
                        </div>
                </form>
        </section>
