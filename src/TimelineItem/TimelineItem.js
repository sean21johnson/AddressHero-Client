...
class TimelineItem extends Component {
    ...
    render() {
        const { city, date_created, event_type, fullname, street, us_state, zip, picture, id } = this.props
                ...
                <li className="Timeline_Item_ListItem">
                    <div className="Timeline_Item_Div">
                        <div className="Timeline_Image_Div">
                            <Link to={`/contacts/${id}`}>
                            <img className="Timeline_Image" src={picture} alt="Timeline_Picture"></img>
                            </Link>
                        </div>
                        <div className="Timeline_Details_Div">
                            <div className="Timeline_Details_DateName">
                            {`${this.handleDateFormat(date_created)}: ${event_type} Card sent to `}
