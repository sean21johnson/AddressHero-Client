					...
					<li className="Contact_Items">
						...
						<div className="Contact_Details_Div">
							<div className="Contact_Name_Container">
								<div className="Contact_Name_Title">Name:</div>
								<div className="Contact_Name_Name">{fullname}</div>
							</div>
							<div className="Contact_Name_Number">
								<div className="Contact_Name_Phone">Phone Number:</div>
							...
							{profileButtonView === true ? (
								<div className="Contact_Name_Button">
									<Link to={`/contacts/${id}`}>
										<button
											onClick={handleProfileButtonViewToFalse}
											className="Contact_Profile_Button"
										>
											View Profile
										</button>
									</Link>
								...
								<div className="Contact_Delete">
									<form onSubmit={this.deleteContact}>
										<button type="submit" className="Contact_Delete_Button">
											Delete Contact
										</button>
									</form>
								</div>
